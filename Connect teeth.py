...
# mesh, densities = o3d.geometry.TriangleMesh.create_from_point_cloud_poisson(pcd_pair, depth=depth_mesh,linear_fit=False)
...
pcd= o3d.geometry.PointCloud()
arr_1=np.asarray(list_tooth[8])
arr_2=np.asarray(list_tooth[9])
arr_p=np.concatenate((arr_1,arr_2),axis=0)
pcd.points = o3d.utility.Vector3dVector(arr_p)
...
# tooth_11 = pv.read('pair_mesh_10.ply')
# tooth_12 = pv.read('pair_mesh_11.ply')
# tooth_13 = pv.read('pair_mesh_12.ply')
#
# p = pv.Plotter()
# p.add_mesh(tooth_1)
# p.add_mesh(tooth_2)
